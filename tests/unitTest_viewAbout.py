...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        # find 'Copyright Logo' and click it – note this is all one Python statement
        elem = driver.find_element(By.XPATH, '/html/body/div[4]/div[3]/h2/a').click()
        time.sleep(3)  # pause to allow screen to change
        try:
            # verify Summary button exists on new screen after clicking "Customers" button

            print("Test passed - Clicking the About link opens the page")
            assert True

        except NoSuchElementException:
            self.fail("Test failed- Clicking the About link does not open the page")
